export default function Faq(){
    return(
        <>
         <section id="secao-faq-nav" class="secao-pagina secao-faq">
            <div class="barra-titulo-secao">
                <h2 class="titulo-secao">PERGUNTAS FREQUENTES</h2>
            </div>
            <div class="wrapper-conteudo-faq">
                <div class="item-faq">
                    <svg class="icone-faq" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="logo-i-inferior-esquerdo">I</div>
        </section>
        </>
    )
}